...
import {
  ...
  BookOpen, Target, User, Lock, ChevronLeft, ChevronRight, X, Play, Check,
  RotateCcw, FlaskConical, Video,
} from "lucide-react";
import { BarChart, Bar, XAxis, ResponsiveContainer, Cell } from "recharts";

// ─── Types ───────────────────────────────────────────────────────────────────

type Screen = "landing" | "about" | "welcome" | "tutorial" | "home" | "flashcard" | "quiz" | "collection" | "progress" | "settings";
...
const ORGS = [
  {
    id: "staph", name: "Staphylococcus aureus", short: "S. aureus",
    ...
    hasArt: true, artColor: "#FFB300", artEmoji: "👑",
    progress: 85, mastered: true, videoUrl: "",
  },
  {
    id: "strep", name: "Streptococcus pyogenes", short: "Strep. pyogenes",
    ...
    hasArt: true, artColor: "#EF5350", artEmoji: "⛓️",
    progress: 60, mastered: false, videoUrl: "",
  },
  {
    id: "pneumo", name: "Streptococcus pneumoniae", short: "S. pneumoniae",
    villain: "The Lancet Phantom", category: "Bacteria", difficulty: "Hard",
    gramStain: "Gram-positive lancet-shaped diplococci (pairs)",
    facts: ["Catalase −", "Alpha-hemolytic", "Encapsulated", "Quellung reaction +", "Optochin sensitive"],
    ...
    virulence: "Polysaccharide capsule (anti-phagocytic), IgA protease, Pneumolysin.",
    pearls: "Rusty sputum = classic. Most common cause of meningitis in adults. Vaccine-preventable.",
    hasArt: false, artColor: "#5C6BC0", artEmoji: "🔱",
    progress: 40, mastered: false, videoUrl: "",
  },
  {
    id: "ecoli", name: "Escherichia coli", short: "E. coli",
    ...
    pearls: "K1 capsule → neonatal meningitis. EHEC O157:H7 → HUS. Never give antibiotics to EHEC → more toxin release.",
    hasArt: true, artColor: "#43A047", artEmoji: "🌿",
    progress: 72, mastered: false, videoUrl: "",
  },
  {
    id: "mening", name: "Neisseria meningitidis", short: "N. meningitidis",
    ...
    pearls: "Most common meningitis in teens/young adults. Non-blanching rash = emergency. Infects asplenic patients.",
    hasArt: false, artColor: "#1565C0", artEmoji: "🫘",
    progress: 20, mastered: false, videoUrl: "",
  },
  {
    id: "pseudo", name: "Pseudomonas aeruginosa", short: "Pseudomonas",
    villain: "The Blue Phantom", category: "Bacteria", difficulty: "Hard",
    gramStain: "Gram-negative rod",
    facts: ["Blue-green pyocyanin pigment", "Grape-like odor", "Oxidase +", "Obligate aerobe", "Non-lactose fermenter"],
    story: "The Blue Phantom leaves a trail of blue-green slime and smells of overripe grapes. He thrives in burn wounds and CF lungs — resistant to almost everything.",
    symptoms: ["Burn wound infections", "CF pneumonia", "Hot tub folliculitis", "Otitis externa (swimmer's ear)"],
    treatment: "Anti-pseudomonal penicillin (Pip-Tazo) + aminoglycoside. Ciprofloxacin (mild).",
    virulence: "Exotoxin A (inhibits EF-2), Alginate biofilm, Pyocyanin, Endotoxin.",
    pearls: "Hot tub folliculitis + swimmer's ear + blue-green pus → Pseudomonas. Ecthyma gangrenosum in neutropenic patients.",
    hasArt: false, artColor: "#00897B", artEmoji: "🧪",
    progress: 15, mastered: false, videoUrl: "",
  },
  {
    id: "tb", name: "Mycobacterium tuberculosis", short: "M. tuberculosis",
    ...
    story: "The Waxy Phantom cannot be Gram stained — his thick mycolic acid coat repels it. Only acid-fast Ziehl-Neelsen stain reveals him. He hides in macrophages for decades.",
    symptoms: ["Night sweats", "Hemoptysis", "Weight loss", "Upper lobe cavitation", "Ghon complex"],
    treatment: "RIPE × 2 months, then RI × 4 months. (Rifampin, Isoniazid, Pyrazinamide, Ethambutol).",
    virulence: "Mycolic acid wall, Cord factor (inhibits phagosome fusion), Sulfatides.",
    pearls: "Upper lobe predilection = high O₂. PPD+ = exposure, not active disease. Caseating granulomas on biopsy.",
    hasArt: false, artColor: "#B71C1C", artEmoji: "🧱",
    progress: 10, mastered: false, videoUrl: "",
  },
  {
    id: "tetani", name: "Clostridium tetani", short: "C. tetani",
    ...
    story: "The Lockjaw General attacks through dirty wounds. His tetanospasmin toxin travels up motor neurons and blocks inhibitory signals — locking every muscle in spasm.",
    symptoms: ["Trismus (lockjaw)", "Opisthotonos", "Risus sardonicus", "Autonomic instability"],
    treatment: "TIG (antitoxin) + Metronidazole + wound debridement + Diazepam (spasms).",
    virulence: "Tetanospasmin: blocks glycine/GABA release → spastic paralysis.",
    pearls: "Blocks INHIBITORY neurons (opposite of Botulinum). Vaccination: TDaP. Recall: Tetanus = Tense (rigid).",
    hasArt: false, artColor: "#4E342E", artEmoji: "🔒",
    progress: 0, mastered: false, videoUrl: "",
  },
  {
    id: "hpylori", name: "Helicobacter pylori", short: "H. pylori",
    villain: "The Ulcer King", category: "Bacteria", difficulty: "Medium",
    gramStain: "Gram-negative spiral rod (curved/S-shaped)",
    facts: ["Urease + (key test)", "Oxidase +", "Microaerophilic", "Flagellated"],
    story: "The Ulcer King uses his urease enzyme to neutralize stomach acid — creating a safe haven in the mucosa. Then he drills ulcers into your stomach wall.",
    ...
    virulence: "Urease (NH₃ neutralizes acid), CagA toxin, VacA vacuolating toxin.",
    pearls: "Most common cause of duodenal ulcer. Urea breath test = active infection. Eradication reduces MALT lymphoma risk.",
    hasArt: false, artColor: "#E65100", artEmoji: "🌀",
    progress: 0, mastered: false, videoUrl: "",
  },
  {
    id: "tpallidum", name: "Treponema pallidum", short: "T. pallidum",
    villain: "The Invisible One", category: "Bacteria", difficulty: "Hard",
    gramStain: "Cannot Gram stain — too thin, lacks visible cell wall. Use darkfield microscopy.",
    facts: ["Spirochete", "Cannot culture", "Darkfield microscopy", "RPR/VDRL → FTA-ABS confirm"],
    ...
    virulence: "Outer membrane proteins, Endoflagella for motility, Evasion of immune system.",
    pearls: "Primary = painless ulcer. Secondary = rash everywhere including palms/soles. Tertiary = cardiovascular + neuro. VDRL false positives: SLE, pregnancy, mono.",
    hasArt: false, artColor: "#546E7A", artEmoji: "👻",
    progress: 0, mastered: false, videoUrl: "",
  },
  {
    id: "cdiff", name: "Clostridioides difficile", short: "C. difficile",
    ...
    pearls: "Classic: post-antibiotic diarrhea, especially after clindamycin or fluoroquinolones. Contact precautions. Spores survive alcohol gels — use soap + water.",
    hasArt: false, artColor: "#6D4C41", artEmoji: "💀",
    progress: 0, mastered: false, videoUrl: "",
  },
  {
    id: "listeria", name: "Listeria monocytogenes", short: "Listeria",
    villain: "The Cold Creeper", category: "Bacteria", difficulty: "Medium",
    gramStain: "Gram-positive rod",
    facts: ["Grows at 4°C (refrigerator temp)", "Tumbling motility", "Intracellular pathogen", "Actin rocket propulsion"],
    story: "The Cold Creeper grows in your refrigerator. He moves through cells by shooting actin rockets — and he loves pregnant women, neonates, and the immunocompromised.",
    ...
    pearls: "Found in deli meats, soft cheese, unpasteurized milk. Second most common neonatal meningitis (after GBS). Use Ampicillin, not cephalosporins.",
    hasArt: false, artColor: "#0288D1", artEmoji: "🧊",
    progress: 0, mastered: false, videoUrl: "",
  },
  {
    id: "anthracis", name: "Bacillus anthracis", short: "B. anthracis",
    villain: "The Anthrax Lord", category: "Bacteria", difficulty: "Hard",
    gramStain: "Gram-positive rod — obligate aerobe",
    facts: ["Spore-forming", "D-glutamate capsule (anti-phagocytic)", "Anthrax toxin (LF + EF + PA)", "Medusa head colonies"],
    ...
    symptoms: ["Cutaneous: painless eschar", "Inhalation: widened mediastinum (mediastinitis)", "GI: bloody diarrhea"],
    treatment: "Ciprofloxacin or Doxycycline. Antitoxin for systemic disease.",
    virulence: "PA (protective antigen) + LF (lethal factor) + EF (edema factor) = anthrax toxin.",
    pearls: "Bioterrorism agent. Spores in animal hides / wool sorters' disease. Widened mediastinum on CXR = inhalation anthrax until proven otherwise.",
    hasArt: false, artColor: "#212121", artEmoji: "☠️",
    progress: 0, mastered: false, videoUrl: "",
  },
  {
    id: "mrsa", name: "Methicillin-resistant S. aureus", short: "MRSA",
    ...
    pearls: "CA-MRSA → skin. HA-MRSA → pneumonia, bacteremia. Daptomycin is inactivated by surfactant → do NOT use for pneumonia.",
    hasArt: true, artColor: "#455A64", artEmoji: "🛡️",
    progress: 45, mastered: false, videoUrl: "",
  },
  {
    id: "candida", name: "Candida albicans", short: "C. albicans",
    villain: "The White Witch", category: "Fungi", difficulty: "Medium",
    gramStain: "Gram-positive fungus (budding yeast + pseudohyphae)",
    facts: ["Germ tube + (at 37°C)", "Pseudohyphae", "KOH prep", "Chlamydospores"],
    ...
    pearls: "Germ tube = rapid ID test. Risk factors: antibiotics, steroids, HIV, diabetes. Esophagitis → dysphagia in AIDS.",
    hasArt: true, artColor: "#AB47BC", artEmoji: "🌸",
    progress: 30, mastered: false, videoUrl: "",
  },
  {
    id: "flu", name: "Influenza A virus", short: "Influenza A",
    ...
    story: "The Flu Phantom changes his disguise each season through antigenic drift. Every decade he pulls off an antigenic shift — causing global pandemics.",
    ...
    pearls: "Drift = gradual (seasonal epidemics). Shift = abrupt reassortment (pandemics). Amantadine → only Influenza A.",
    hasArt: true, artColor: "#1E88E5", artEmoji: "❄️",
    progress: 0, mastered: false, locked: true, videoUrl: "",
  },
];
...
const QUESTIONS = [
  {
    ...
    question: "Catalase and coagulase — what results?",
    options: [
      { id: "A", text: "Catalase + / Coagulase −" },
      { id: "B", text: "Both positive" },
      { id: "C", text: "Catalase − / Coagulase +" },
      { id: "D", text: "Both negative" },
    ],
    correct: "B",
  },
  {
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Cocci in clusters" },
      { id: "B", text: "Lancet-shaped diplococci (pairs)" },
      { id: "C", text: "Cocci in chains" },
      { id: "D", text: "Gram-negative rod" },
    ],
    correct: "B",
  },
  {
    ...
    options: [
      { id: "A", text: "Gram-positive coccus" },
      { id: "B", text: "Gram-positive rod" },
      { id: "C", text: "Gram-negative coccus" },
      { id: "D", text: "Gram-negative rod" },
    ],
    correct: "D",
  },
  {
    ...
    options: [
      { id: "A", text: "Gram-negative diplococci (kidney-bean)" },
      { id: "B", text: "Gram-positive cocci in chains" },
      { id: "C", text: "Gram-positive diplococci (lancet)" },
      { id: "D", text: "Gram-negative rod" },
    ],
    correct: "A",
  },
  {
    ...
    question: "What pigment/smell are diagnostic clues for Pseudomonas?",
    options: [
      { id: "A", text: "Red pigment, sweet smell" },
      { id: "B", text: "Blue-green pyocyanin pigment, grape-like smell" },
      { id: "C", text: "Yellow pigment, ammonia smell" },
      { id: "D", text: "No pigment, odorless" },
    ],
    correct: "B",
  },
  {
    ...
    options: [
      ...
      { id: "B", text: "Giemsa stain" },
      { id: "C", text: "Ziehl-Neelsen (acid-fast) stain" },
      { id: "D", text: "India ink stain" },
    ],
    correct: "C",
  },
  {
    ...
    options: [
      { id: "A", text: "Gram-negative, facultative anaerobe" },
      { id: "B", text: "Gram-positive, obligate anaerobe" },
      { id: "C", text: "Gram-negative, obligate anaerobe" },
      { id: "D", text: "Gram-positive, obligate aerobe" },
    ],
    correct: "B",
  },
  {
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "It stains Gram-negative" },
      { id: "B", text: "It stains Gram-positive" },
      { id: "C", text: "It dissolves during staining" },
      { id: "D", text: "Too thin / lacks a conventional cell wall visible on Gram stain" },
    ],
    correct: "D",
  },
  {
    ...
    options: [
      { id: "A", text: "Gram-negative rod, facultative anaerobe" },
      { id: "B", text: "Gram-negative rod, obligate anaerobe" },
      { id: "C", text: "Gram-positive rod, obligate anaerobe" },
      { id: "D", text: "Gram-positive rod, obligate aerobe" },
    ],
    correct: "C",
  },
  {
    ...
    options: [
      { id: "A", text: "Gram-positive rod, grows in cold temperatures" },
      { id: "B", text: "Gram-negative rod, grows in cold temperatures" },
      { id: "C", text: "Gram-positive rod, strictly warm-growing" },
      { id: "D", text: "Gram-positive coccus, heat-tolerant" },
    ],
    correct: "A",
  },
  {
    ...
    options: [
      { id: "A", text: "Gram-positive rod, obligate aerobe" },
      { id: "B", text: "Gram-positive rod, obligate anaerobe" },
      { id: "C", text: "Gram-negative rod, obligate aerobe" },
      { id: "D", text: "Gram-positive coccus, facultative anaerobe" },
    ],
    correct: "A",
  },
] as const;
...
// ─── Creator Cat Characters ───────────────────────────────────────────────────

function SrCat({ size = 160 }: { size?: number }) {
  // Christopher Reeves Sr. — distinguished gray bearded cat, stethoscope + suit
  return (
    <svg width={size} height={size} viewBox="0 0 200 220" fill="none">
      ...
      {/* Distinguished beard — fluffy chin fur */}
...
function CalebCat({ size = 160 }: { size?: number }) {
  // Caleb Reeves — orange tabby cat, bow and arrow, young + energetic
  return (
    <svg width={size} height={size} viewBox="0 0 200 220" fill="none">
      {/* Body / casual clothes */}
      ...
      <path d="M92 120 Q106 130 120 120" fill="#FDEBD0" opacity="0.4"/>
      {/* Whiskers */}
...
function ChrisCat({ size = 160 }: { size?: number }) {
  // Christopher Reeves — brown/tawny cat, holding a sword, thoughtful + creative
  return (
    <svg width={size} height={size} viewBox="0 0 200 220" fill="none">
      {/* Body / smart-casual */}
      ...
      {/* Thoughtful brow — one slightly raised */}
      ...
      {/* Small design tool detail — pencil behind ear */}
...
function PlaceholderArt({ color, emoji, size = 160 }: { color: string; emoji: string; size?: number }) {
  const s = size;
  return (
    <svg width={s} height={s} viewBox={`0 0 ${s} ${s}`} fill="none">
      <circle cx={s / 2} cy={s / 2} r={s / 2 - 6} fill={color + "18"} stroke={color + "55"} strokeWidth="2.5" strokeDasharray="10 5" />
      <circle cx={s / 2} cy={s / 2} r={s / 3.5} fill={color + "22"} />
      <text x={s / 2} y={s / 2 + s * 0.12} textAnchor="middle" fontSize={s * 0.28} fontFamily="system-ui">{emoji}</text>
      <text x={s / 2} y={s / 2 + s * 0.38} textAnchor="middle" fontSize={s * 0.07} fill="#A8A8A8" fontFamily="system-ui" fontWeight="500" letterSpacing="0.08em">ART COMING SOON</text>
    </svg>
  );
}

function renderVillain(id: string, size = 160) {
  switch (id) {
    ...
    default: {
      ...
      return org ? <PlaceholderArt color={org.artColor} emoji={org.artEmoji} size={size} /> : <StaphFace size={size} />;
    }
  }
}
...
export default function App() {
  ...
  const qOrg = ORGS.find(o => o.id === qCard.orgId)!;
  ...
  const resetQuiz = () => {
    ...
    setQStreak(0); setQXP(0); setQCombo(0);
    setQDone(false); setQCorrectCount(0);
  };
  ...
  const Welcome = (
    <div className="flex flex-col h-full bg-white">
      <div className="flex-1 flex flex-col items-center justify-center px-7 gap-0 pt-10">
  ...
  const tutPages = [
    {
      subtitle: "Your cast of characters",
      title: "Meet Your Villains",
      ...
      visual: (
        <div className="flex items-center justify-center gap-3">
          ...
          <div className="z-10 drop-shadow-xl"><StaphFace size={134} /></div>
          <div className="opacity-35 scale-75 origin-left"><EcoliFace size={90} /></div>
        </div>
      ),
    },
    {
      subtitle: "The visual grammar",
      title: "Symbolism Key",
          ...
          {[
            ...
            <div key={r.label} className="flex items-center gap-3 bg-[#F8F8F8] border border-[#E7E7E7] rounded-xl px-3 py-2.5">
              ...
              <div className="flex-1">
                ...
                <span className="text-[12px] text-[#666]"> → {r.meaning}</span>
              </div>
            </div>
          ))}
        </div>
    ...
    {
      subtitle: "Stories, symptoms, treatment",
      title: "Flip & Remember",
      body: "Each card has a memory story on the front and clinical details on the back — diagnosis, treatment, virulence factors, and exam tips.",
      visual: (
        <div className="flex items-center justify-center gap-3">
          ...
          <div className="w-[128px] h-[115px] bg-[#F8F8F8] border border-[#E7E7E7] rounded-2xl p-3 flex flex-col justify-between shadow-sm">
            <div className="text-[10px] text-[#A8A8A8] uppercase tracking-wider font-medium">Treatment</div>
            <div className="text-[11px] text-[#333] leading-snug">Fluoroquinolones<br />or TMP-SMX</div>
            <div className="text-[10px] text-[#A8A8A8]">+ 4 more sections</div>
          </div>
        </div>
      ),
    },
    {
      subtitle: "Quiz, streaks, achievements",
      title: "Study. Streak. Conquer.",
      ...
      <div className="px-6 flex flex-col gap-4 overflow-y-auto">
        ...
        <div className="bg-[#F8F8F8] border border-[#E7E7E7] rounded-2xl p-4">
          ...
          <div className="h-2 bg-[#E7E7E7] rounded-full overflow-hidden">
            <motion.div className="h-full bg-black rounded-full" initial={{ width: 0 }} animate={{ width: "25%" }} transition={{ duration: 1, ease: "easeOut" }} />
          </div>
        </div>
  ...
  const cardSections = [
    ...
    { key: "symptoms", icon: "🩺", title: "Symptoms", body: currentOrg.symptoms.join(" · ") },
  ];
    ...
    <div className="flex flex-col bg-white h-full">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-32 flex flex-col gap-4">
        ...
        <div className="relative overflow-hidden">
              ...
              {!cardFlipped ? (
                ...
                <div className="bg-[#F8F8F8] border border-[#E7E7E7] rounded-[28px] overflow-hidden select-none" style={{ boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
                  <div className="flex items-center justify-center py-8" style={{ background: `radial-gradient(ellipse at center, ${currentOrg.artColor}18 0%, transparent 70%)` }}>
                    {renderVillain(currentOrg.id, 164)}
                  </div>
          ...
          {/* Swipe hint arrows */}
          <div className="absolute top-1/2 -translate-y-1/2 left-1 flex pointer-events-none">
          ...
          <div className="absolute top-1/2 -translate-y-1/2 right-1 flex pointer-events-none">
    ...
    <div className="flex flex-col h-full bg-white items-center justify-center px-7">
      <motion.div className="w-full text-center" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        <div className="text-6xl mb-5">
          {qCorrectCount === totalQ ? "🏆" : qCorrectCount >= totalQ * 0.8 ? "⭐" : "📚"}
        </div>
        <h2 className="text-[26px] font-bold text-black tracking-tight mb-1">Quiz Complete!</h2>
        <p className="text-[14px] text-[#666] mb-8">
          {qCorrectCount === totalQ ? "Perfect score — flawless!" : `${qCorrectCount} of ${totalQ} correct`}
        </p>
        <div className="grid grid-cols-3 gap-3 mb-8">
          {[
            { val: `${qCorrectCount}/${totalQ}`, label: "Correct" },
            { val: `${qStreak}`, label: "Best Streak" },
            { val: `${qXP}`, label: "XP Earned" },
          ].map(({ val, label }) => (
        ...
        <button onClick={() => nav("collection")} className="w-full h-12 mt-2 text-[#666] font-medium text-[14px]">
          Browse Collection
        </button>
      </motion.div>
    </div>
    ...
    <div className="flex flex-col bg-white h-full">
      ...
      <div className="flex items-center justify-between px-6 pt-14 pb-3">
        ...
        <div className="flex items-center gap-2">
          <AnimatePresence>
            {qStreak > 0 && (
              <motion.div className="flex items-center gap-1.5 bg-[#F8F8F8] border border-[#E7E7E7] rounded-full px-3 py-1.5"
          ...
          <AnimatePresence>
            {qCombo > 1 && (
              <motion.div className="flex items-center gap-1.5 rounded-full px-3 py-1.5 border"
                style={{ background: "rgba(255,213,74,0.15)", borderColor: "rgba(255,213,74,0.6)" }}
                initial={{ scale: 0 }} animate={{ scale: 1 }} exit={{ scale: 0 }}>
                <Zap className="w-3.5 h-3.5 text-yellow-600" /><span className="text-[12px] font-semibold">×{qCombo}</span>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
      ...
      <div className="flex-1 px-6 flex flex-col gap-3.5 overflow-y-auto pb-8">
        ...
        <div className="relative">
            ...
            <div className="absolute inset-0 rounded-[24px] overflow-hidden pointer-events-none z-30">
              {CONFETTI.map(p => (
                <motion.div key={p.id} className="absolute rounded-sm"
                  ...
                  animate={{ y: 260, opacity: 0, rotate: 200 }}
          ...
          <motion.div
            ...
            animate={
              qPhase === "correct" ? { scale: [1, 1.04, 1], y: [0, -5, 0] }
                : qPhase === "wrong" ? { x: [0, -10, 10, -6, 6, 0] }
                : { scale: 1, y: 0, x: 0 }
            }
          ...
          >
            ...
            <motion.div className="relative z-10"
              animate={qPhase === "correct" ? {
                filter: ["drop-shadow(0 0 0px rgba(255,213,74,0))", "drop-shadow(0 0 28px rgba(255,213,74,0.9))", "drop-shadow(0 0 12px rgba(255,213,74,0.4))"],
              } : { filter: "none" }}
            ...
            <div className="relative z-10 text-center px-5 mt-2">
              {qCard.tag && (
                <div className="inline-block text-[10px] font-bold uppercase tracking-[0.14em] text-[#A8A8A8] border border-[#E7E7E7] rounded-full px-3 py-1 mb-2">
                  {qCard.tag}
                </div>
              )}
            ...
            <AnimatePresence>
              {qPhase === "correct" && (
                <motion.div className="absolute inset-0 flex flex-col items-center justify-center rounded-[24px] z-20"
                  ...
                  <div className="text-[13px] font-semibold mt-1" style={{ color: "#B8860B" }}>
                    +{qXPGain} XP{qCombo > 1 && ` · Combo ×${qCombo}`}
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
        ...
        {/* Answer buttons — vertical, full width, A/B/C/D labels */}
        <div className="flex flex-col gap-2">
          {qOpts.map(opt => {
            ...
            if (answered) {
              if (isCor) {
                bg = "bg-[#A3E635]/10"; border = "border-[#A3E635]";
                pillBg = "bg-[#A3E635]"; pillTxt = "text-black";
              } else if (isSel) {
                bg = "bg-[#FF6B6B]/10"; border = "border-[#FF6B6B]";
                pillBg = "bg-[#FF6B6B]"; pillTxt = "text-white";
              } else {
                txtCol = "text-[#A8A8A8]"; border = "border-[#E7E7E7]"; bg = "bg-[#F8F8F8]";
              }
            }
            return (
              <motion.button key={opt.id}
                ...
                <div className={`w-7 h-7 rounded-full flex items-center justify-center text-[12px] font-bold flex-shrink-0 ${pillBg} ${pillTxt}`}>
                  {opt.id}
                </div>
        ...
        {ORGS.map((v, vi) => {
          ...
          return (
            ...
            >
              ...
              {/* Favorite — div not button to avoid nesting */}
              <div
                role="button"
                tabIndex={0}
    ...
    <div className="flex flex-col bg-white min-h-full overflow-y-auto">
      ...
      <div className="px-6 mb-6">
        ...
        {[
          ...
          { n: "02", title: "Flip the Card", body: "Front = memory story + visual cues. Back = diagnosis, treatment, virulence factors, exam pearls." },
